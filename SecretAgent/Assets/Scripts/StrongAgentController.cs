...
public class StrongAgentController : Agent
{
    ...
    public override void OnEpisodeBegin()
    {
        ...
        bool distanceGood = aObject.CheckOverlap(civilian.transform.localPosition, spawnLocation, 1f);
        ...
        while (!distanceGood && attempt < maxAttempts)
        {
            ...
            distanceGood = aObject.CheckOverlap(civilian.transform.localPosition, spawnLocation, 1f);
            attempt++;
        }
